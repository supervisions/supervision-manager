    ...
    <div class="con-right" id="conRight">
		<div class="fl yw-lump">
			<div class="yw-lump-title">
				<i class="yw-icon icon-partner"></i><span>方案明细</span>
		...
		<div class="fl yw-lump mt10">
			<form id="DeviceForm" name="DeviceForm"
				...
				<div class="pd10">
					...
					<div class="fr">
						<span class="fl yw-btn bg-green cur" onclick="window.location.href='manage/casedetail/casedetailInfo.do?pointId='+ 0">新建项目</span>
					</div>
					<div class="cl"></div>
				</div>
