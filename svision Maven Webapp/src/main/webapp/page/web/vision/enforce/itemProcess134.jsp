				...
				<div id="tab1" class="yw-tab">
					<table class="font16 taskTable" >
						...
						<c:if test="${ItemProcess5 != null }">
							<tr>
								<td align="right" style="height:40px;">意见书、检查报告说明：</td>
								<td colspan="3">
						...
						<tr>
							<td align="right" >是否处罚：</td>
							<td colspan="3">
								<label>
									<input type="radio" name="status" value="0" checked="checked">不处罚
								</label> 
								<label>
									<input type="radio" name="status" value="1" >处罚
								</label>								
							</td>	
						</tr>
						<tr>
