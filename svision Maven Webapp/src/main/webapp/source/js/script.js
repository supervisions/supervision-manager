var App = function () {
	...
	var handleBackstretch = function () {
		 $.backstretch([
		"source/img/login/1.jpg"
		, "source/img/login/2.jpg"
		, "source/img/login/3.jpg"
		, "source/img/login/4.jpg"
		], {duration: 3000, fade: 750});
	}
	var handleBackstretch_Client = function () {
		$.backstretch([
			"../../source/img/login/2.jpg"
		], {duration: 3000, fade: 750});
	}
	...
	return {
        ...
        init: function () {
			...
			if (App.isPage("client_main_page")) {
				handleUniform();	//Function to handle uniform inputs
				handleBackstretch_Client();	//Function to handle background images
			}
			if (App.isPage("chats")) {
				handleChat('chat-window');	//Function to handle chat
